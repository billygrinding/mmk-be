...
func (c *healthCheckServiceClient) HealthCheck(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedHealthCheckServiceServer) HealthCheck(context.Context, *Request) (*Response, error) {
...
func _HealthCheckService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthCheckServiceServer).HealthCheck(ctx, req.(*Request))
	}
...
var HealthCheckService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "app/proto/healthcheck.proto",
}
